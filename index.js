...
wjs.prototype.togglePause = function() {
    if (!this.playing()) {
        if (this.itemCount() > 0) {
            this.play();
            this.notify("<i class=\"fa fa-play fa-3x\" data-l10n-id=\"hint_pause\" ></i>", true);
        }
    } else {
        this.pause();
        this.notify("<i class=\"fa fa-pause fa-3x\" data-l10n-id=\"hint_pause\" ></i>", true);
    }
    return this;
}

wjs.prototype.pauseNotify = function() {
    if (!this.playing()) {
        if (this.itemCount() > 0) this.notify("<i class=\"fa fa-pause fa-3x\"></i>", true);
    } else this.notify("<i class=\"fa fa-play fa-3x\" ></i>", true);
    return this;
}
...
wjs.prototype.addPlayer = function(wcpSettings) {
    ...
    playerbody = '<div' + targetid + ' style="height: 100%"><div class="wcp-center" style="overflow: hidden"><canvas class="wcp-canvas wcp-center"></canvas></div><div class="wcp-surface"></div><div class="wcp-menu wcp-playlist wcp-center"><div class="wcp-menu-close"></div><div class="wcp-menu-title">Playlist Menu</div><ul class="wcp-menu-items wcp-playlist-items"></ul></div><div class="wcp-menu wcp-subtitles wcp-center"><div class="wcp-menu-close"></div><div class="wcp-menu-title">Subtitle Menu</div><ul class="wcp-menu-items wcp-subtitles-items"></ul></div><div class="wcp-pause-anim wcp-center"><i class="wcp-anim-basic wcp-anim-icon-play"></i></div><div class="wcp-toolbar"><div></div><div class="wcp-progress-bar"><div class="wcp-progress-seen"></div><div class="wcp-progress-pointer"></div></div><div class="wcp-button wcp-left wcp-prev" style="display: none"></div><div class="wcp-button wcp-left wcp-pause"></div><div class="wcp-button wcp-left wcp-next" style="display: none"></div><div class="wcp-button wcp-left wcp-vol-button wcp-volume-medium"></div><div class="wcp-vol-control"><div class="wcp-vol-bar"><div class="wcp-vol-bar-full"></div><div class="wcp-vol-bar-pointer"></div></div></div><div class="wcp-time"><span class="wcp-time-current"></span><span class="wcp-time-total"></span></div><div class="wcp-button wcp-right wcp-maximize"';
...
wjs.prototype.notify = function(newMessage, html) {
    if (typeof html === 'undefined') this.find(".wcp-notif").text(newMessage);
    else this.find(".wcp-notif").html(newMessage);
